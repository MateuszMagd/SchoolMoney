    ...
    return (
        ...
        <div className="flex flex-col mx-auto bg-white rounded-[30px] shadow-lg" style={{ height: '710px', width: '580px' }}>
            ...
            <div className="flex flex-row items-center justify-center space-x-4">
                ...
                <RouterButton page="parent-details/edit" buttonString="Edytuj" color="bg-dark_blue" width="w-[150px]" height="h-[50px] "/>
                <RouterButton page="parent-details/reports" buttonString="Generuj Raporty"color="bg-dark_blue" width="w-[150px]" height="h-[50px]"/>
